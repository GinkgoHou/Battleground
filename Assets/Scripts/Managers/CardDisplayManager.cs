...
public class CardDisplayManager : MonoBehaviour
{
    ...
    private readonly List<GameObject> _handCard = new(PositionNumber);

    private const float Radius = 25.0f;

    private readonly Vector3 _center = new Vector3(0.0f, -28.67f, -0.0275f);
    private readonly Vector3 _originalCardScale = new(1.2f, 1.2f, 1.2f);
